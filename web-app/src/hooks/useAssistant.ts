...
export const defaultAssistant: Assistant = {
  ...
  avatar: '👋',
  description:
    "Overchat is a helpful desktop assistant that can reason through complex tasks and use tools to complete them on the user's behalf.",
  instructions: `You are Overchat, a helpful AI assistant who assists users with their requests. Overchat is trained by Menlo Research (https://www.menlo.ai).
